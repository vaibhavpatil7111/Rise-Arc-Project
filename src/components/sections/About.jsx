...
const About = () => {
  ...
  return (
    <section id="about" className="section-padding bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-blue-900 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="container-max relative z-10">
        ...
        >
          ...
          >
            We're a premium freelance digital agency specializing in modern web solutions. 
            Our mission is to help businesses thrive in the digital landscape with 
            ...
            <div className="relative bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl p-8 rounded-3xl border border-gray-200/50 dark:border-gray-700/50">
              ...
              <div className="space-y-6">
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed text-lg">
                  At RiceArc, we combine technical expertise with creative vision to deliver 
                  digital solutions that not only look exceptional but perform flawlessly. 
                  Every project is crafted with attention to detail, modern best practices, 
                  and a focus on your business goals.
                </p>
                
                <p className="text-gray-600 dark:text-gray-300 leading-relaxed text-lg">
                  From responsive websites to AI-powered chatbots, we leverage the latest 
                  technologies to ensure your digital presence stands out in today's 
                  competitive market.
                </p>
                ...
                >
                  ...
                  <div>
                    <p className="font-semibold text-gray-900 dark:text-white">This Year's Achievement</p>
                    <p className="text-sm text-gray-600 dark:text-gray-300">10+ Happy Clients with Premium Service Delivery</p>
                  </div>
                </motion.div>
              </div>
            </div>
