...
import { Zap, Shield, Target, Smartphone, Clock, HeadphonesIcon } from 'lucide-react'
  ...
  const reasons = [
    {
      ...
      description: 'We use the latest technologies and frameworks to ensure your project is built for the future, not the past.',
    ...
    },
    {
      ...
      description: 'Your goals are our goals. We work closely with you to understand your vision and deliver exactly what you need.',
    ...
    },
    {
      ...
      description: 'Every project is optimized for speed, search engines, and user experience from day one.',
    ...
    },
    {
      ...
      description: 'Beautiful, intuitive interfaces that users love and that drive conversions for your business.',
    ...
    },
    {
      ...
      description: 'We respect your timeline and deliver high-quality work within agreed deadlines without compromising quality.',
    ...
    },
    {
      ...
      description: 'Our relationship doesn\'t end at launch. We provide ongoing support and maintenance for your peace of mind.',
  ...
  return (
    <section className="section-padding bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-blue-900 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-conic from-blue-500/5 via-purple-500/5 to-pink-500/5 rounded-full blur-3xl animate-spin" style={{animationDuration: '25s'}}></div>
      </div>
      ...
      <div className="container-max relative z-10">
        ...
        >
          ...
          >
            We don't just build websites and applications – we create digital experiences 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
          {reasons.map((reason, index) => (
            ...
            >
              ...
              <div className={`absolute inset-0 bg-gradient-to-br ${reason.bgGradient} opacity-0 group-hover:opacity-100 rounded-3xl transition-opacity duration-500`}></div>
              
              {/* Content */}
              <div className="relative z-10 p-8">
                {/* Static Icon */}
                <div className="mb-6">
                  <div className={`w-16 h-16 bg-gradient-to-br ${reason.gradient} rounded-3xl flex items-center justify-center shadow-2xl mx-auto`}>
              ...
              {/* Hover Glow Effect */}
              <div className={`absolute inset-0 bg-gradient-to-br ${reason.gradient} opacity-0 group-hover:opacity-10 rounded-3xl blur-xl transition-opacity duration-500`}></div>
          ...
          >
            ...
            <div className="relative bg-white/90 dark:bg-gray-800/90 backdrop-blur-xl p-12 rounded-3xl border border-gray-200/50 dark:border-gray-700/50 shadow-2xl">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-8 leading-relaxed text-lg max-w-3xl mx-auto">
                Join the growing number of businesses that trust RiceArc to deliver 
